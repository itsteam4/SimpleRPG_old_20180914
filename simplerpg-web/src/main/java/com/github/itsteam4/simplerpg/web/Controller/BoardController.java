...
public class BoardController {
	...
	@Autowired
	private NoticeBoardPaging inquiryboardpaging;
	static String find;
	...
	@RequestMapping(value = "/noticeboardpagelist", method = RequestMethod.GET)
	public String noticeboardpagelist(Model model, String find) {
		if (find == null) {
			find = "";
		}
		this.find = find;
	...
	@RequestMapping(value = "/inquiryboardpagelist", method = RequestMethod.GET)
	public String inquiryboardpagelist(Model model, String find) {
		if (find == null) {
			find = "";
		}
		this.find = find;
		...
		return "board/inquiryboard_page_list";

	}

	@RequestMapping(value = "/gameboardpagelist", method = RequestMethod.GET)
	public String gameboardpagelist(Model model, String find) {
		if (find == null) {
			find = "";
		}
		this.find = find;
