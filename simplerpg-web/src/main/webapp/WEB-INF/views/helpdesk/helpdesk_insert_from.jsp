...
<body onload="init()">
	<form class="helpdeskinput_form" name="helpdeskinput_form"
		action="helpdeskInsert" method="post" enctype="multipart/form-data"
		role="form" data-parsley-validate="true">
		<div class="container">
			<span class="hidden" id="dochecked"></span>
				...
				<div class="col-md-6">
					<div>
						<div class="input-group">
							...
							</span> <input name="h_email" id="h_email" value="${sessionemail}"
								class="form-control" type="email" size="20" />
						</div>
					</div>
				</div>
			</div>
					...
					<div>
						<div class="input-group">
							<span class="input-group-addon"> <i
								...
								type="text" size="100" autofocus required="true"
