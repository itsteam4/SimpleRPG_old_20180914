    ...
    <div class="mb-4" id="accordion" role="tablist" aria-multiselectable="true">
        <div class="card">
          <div class="card-header" role="tab" id="headingOne" >
            <h5 class="mb-0">
              <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" >게임을 만들게된 계기</a>
            </h5>
          </div>
          ...
          <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
            <div class="card-body">
             ...
             어린시절 자주 하던 너구리, 고인돌 같은 2D게임을 추억하며, 다시 2D게임들이 가끔 출시되기도 합니다.
            </div>
          </div>
        </div>
        <div class="card">
