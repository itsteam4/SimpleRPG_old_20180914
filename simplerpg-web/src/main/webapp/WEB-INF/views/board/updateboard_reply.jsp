		...
		<div class="container" style="text-align: center">
			...
			<div class="row">
				...
				<div class="input-group mb-3 col-md-6 ">
					...
					<input type="text" id="u_title" name="u_title" class="form-control" value="${board.u_title}" required="true">
				</div>
				<div class="col-md-3"></div>
			</div>
			<div class="row">
