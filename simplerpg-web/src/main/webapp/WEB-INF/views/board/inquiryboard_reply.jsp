...
<body onload="inquiryboard_reply.b_content.focus()">
	<form id="inquiryboard_reply" name="inquiryboard_reply" action="inquiryboardreplyinsert" method="post" enctype="multipart/form-data">
